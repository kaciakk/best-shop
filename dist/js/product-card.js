...
informationsDescription === null || informationsDescription === void 0 ? void 0 : informationsDescription.addEventListener("submit", (event) => {
    event.preventDefault();
    const form = event.target;
    if (!(form instanceof HTMLFormElement))
        return;
    if (form.id !== "information-form")
        return;
    alert("Form submitted");
    form.reset();
});
buttonDetails === null || buttonDetails === void 0 ? void 0 : buttonDetails.addEventListener("click", () => {
    informationsDescription === null || informationsDescription === void 0 ? void 0 : informationsDescription.innerHTML = `  <div class="informations__description">
...
buttonReviews === null || buttonReviews === void 0 ? void 0 : buttonReviews.addEventListener("click", () => {
    informationsDescription === null || informationsDescription === void 0 ? void 0 : informationsDescription.innerHTML = `  <div class="informations__reviews">
...
buttonShipping === null || buttonShipping === void 0 ? void 0 : buttonShipping.addEventListener("click", () => {
    informationsDescription === null || informationsDescription === void 0 ? void 0 : informationsDescription.innerHTML = `  <div class="informations__description">
  <p class="text-body text-body--sm text-body--secondary">
